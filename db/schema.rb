...
ActiveRecord::Schema[8.0].define(version: 2026_09_09_140000) do
  ...
  create_table "user_imports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["creator_id"], name: "index_user_imports_on_creator_id"
    t.index ["status"], name: "index_user_imports_on_status"
  end
  ...
  add_foreign_key "user_imports", "users", column: "creator_id"
end
